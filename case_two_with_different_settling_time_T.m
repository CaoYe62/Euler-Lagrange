...
clear all ;
close all ;
%% the comparison of different settling times T
...
%% control design parameters for T=0.5

F11_2=0.3; F12_2=0.3; 
F21_2=3; F22_2=3;
 
 
T_2=0.5; epsilon_2=0.02; b1_2=epsilon_2/(sqrt(2)*F11_2); b2_2=epsilon_2/(sqrt(2)*F12_2);
...
%% control design parameters for T=2

F11_1=0.3; F12_1=0.3; 
F21_1=3; F22_1=3;
 
 
T_1=2; epsilon_1=0.02; b1_1=epsilon_1/(sqrt(2)*F11_1); b2_1=epsilon_2/(sqrt(2)*F12_1);
k1_1=4; r1_1=2; w1_1=0.001;
...
for i=1:1:n
    ...
    %% accelerate transformation in (13)  for T=0.5
    if tt<T_2
   ...
   %% accelerate transformation in (13)  for T=2
    if tt<T_1
...
h=legend({'$T=2$','boundary curve'},'interpreter','latex');
...
h=legend({'$T=0.5$','boundary curve'},'interpreter','latex');
xlabel('Time(sec)','FontName','Times New Roman','FontSize',16);
ylabel('$||e||$','interpreter','latex','linewidth',20);
set(h,'Fontsize',16);
...
h=legend({'$T=2$'},'interpreter','latex');
xlabel('Time(sec)','FontName','Times New Roman','FontSize',16);
...
h=legend({'$T=0.5$'},'interpreter','latex');
xlabel('Time(sec)','FontName','Times New Roman','FontSize',16);
ylabel('$u_1$','interpreter','latex','linewidth',20);
set(h,'Fontsize',16);
